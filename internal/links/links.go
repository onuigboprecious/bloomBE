...
func (s *Service) seedDefaults() {
	...
	s.links["demo-user-id"] = []models.CustomLink{
		{ID: "lnk-1", UserID: "demo-user-id", Label: "My Design Portfolio", URL: "https://enlazer.cloud/@kelvin", Order: 1, CreatedAt: time.Now()},
		{ID: "lnk-2", UserID: "demo-user-id", Label: "Book 1-on-1 Consultation", URL: "https://calendly.com/kelvin-uche/30min", Order: 2, CreatedAt: time.Now()},
		{ID: "lnk-3", UserID: "demo-user-id", Label: "Watch YouTube Builds", URL: "https://youtube.com/@kelvin_builds", Order: 3, CreatedAt: time.Now()},
	}
}
